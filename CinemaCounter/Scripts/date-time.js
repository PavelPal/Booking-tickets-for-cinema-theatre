	        ...
	        this.template = '<div class="dtp hidden" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										'<button class="dtp-btn-now mui-btn mui-btn--small hidden">' + this.params.nowText + '</button>' +
										'<button class="dtp-btn-clear mui-btn mui-btn--small hidden">' + this.params.clearText + '</button>' +
										'<button class="dtp-btn-cancel mui-btn mui-btn--small">' + this.params.cancelText + '</button>' +
										'<button class="dtp-btn-ok mui-btn mui-btn--small">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
